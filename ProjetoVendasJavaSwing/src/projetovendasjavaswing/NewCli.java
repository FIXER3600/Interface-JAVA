 ...
 * @author Aluno
 */
public class NewCli extends javax.swing.JFrame {

    /**
     * Creates new form NewCli
     */
    public NewCli() {
        initComponents();
    }
   ...
   this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
