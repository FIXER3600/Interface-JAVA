 ...
 * @author Aluno
 */
public class AlterCli extends javax.swing.JFrame {

    Cliente clienteAlterar;
    public AlterCli(Cliente cliente){
        initComponents();
   ...
   public void centralizeFrame(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
